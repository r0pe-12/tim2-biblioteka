        ...
        checked.each(function () {
            ...
            if (/\/settings\/.*/gm.test(path)) {
                ...
                if (path == '/aktivne-rezervacije/' || /\/students\/.*\/aktivne-rezervacije/i.test(path)){
                    ...
                    if (path === '/izdate/' || path === '/vracene/' || path === '/prekoracene/' || /\/students\/.*\/izdate/i.test(path) || /\/students\/.*\/vracene/i.test(path) || /\/students\/.*\/otpisane/i.test(path) || /\/students\/.*\/prekoracene/i.test(path)) {
