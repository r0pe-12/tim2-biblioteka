<x-layout>
    ...
    <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
        ...
        <form id="form" method="POST" action="{{ route('genre.update', $genre) }}"  class="text-gray-700 forma" enctype="multipart/form-data">
        @method('PUT')
        @csrf
                    ...
                    <div class="flex flex-row">
                        <div class="inline-block w-full text-white text-right py-[7px] mr-[100px]">
                            ...
                            <button id="sacuvajZanrEdit" type="submit"
                                    class="btn-animation shadow-lg mr-[30px] w-[150px] disabled:opacity-50 focus:outline-none text-sm py-2.5 px-5 transition duration-300 ease-in rounded-[5px] hover:bg-[#46A149] bg-[#4CAF50]" onclick="validacijaZanrEdit(event)">
