<x-layout>
    ...
    @endsection
        ...
        <!-- Delete Many Genres Modal -->
        <div class="modal fadeM" id="deleteManyModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="{{ route('genre.bulkDelete') }}">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Da li želite obrisati sljedeće žanrove: </h5>
        ...
        <section class="w-screen h-screen pl-[80px] py-4 text-gray-700">
            ...
            <div class="height-kategorije pb-[30px] scroll">
                ...
                <div class="flex items-center px-[50px] py-8 space-x-3 rounded-lg">
                    ...
                    <a href="#" class="text-red-800 multiple" id="deleteMany" hidden data-toggle="modal" data-target="#deleteManyModal"><i class="fa fa-trash ml-4"></i> Izbriši žanrove</a>


                    <a class="text-blue-800 one" hidden id="edit" href="#"><i class="far fa-edit"></i> Izmjeni žanr</a>
                    <a href="#" class="text-red-800 one deleteOne" id="deleteOne" hidden data-toggle="modal" data-target="#deleteOneModal"><i class="fa fa-trash ml-4"></i> Izbriši žanr</a>
                </div>
                    <div
                    ...
                    <table class="overflow-hidden shadow-lg rounded-xl min-w-full border-[1px] border-[#e4dfdf]" id="myTable">
                        <thead class="bg-[#EFF3F6]">
                            <tr id="head" class="border-b-[1px] border-[#e4dfdf]">
                                ...
                                <th class="px-4 py-4 leading-4 tracking-wider text-left">Naziv žanra<a href="#"></a>
                                </th>
                        ...
                        <tbody id="myTableBody" class="bg-white">
                            @foreach($genres as $genre )
                                ...
                                <td class="px-4 py-4 whitespace-no-wrap">
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" class="form-checkbox checkOthers" data-name="{{ $genre->name }}" data-id="{{ $genre->id }}">
                                    </label>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm leading-5 text-right whitespace-no-wrap">
                                    ...
                                    <div
                                        ...
                                        <div class="absolute right-[25px] w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                            ...
                                            <div class="py-1">
                                                <a href="{{ route('genre.edit', $genre) }}" tabindex="0"
