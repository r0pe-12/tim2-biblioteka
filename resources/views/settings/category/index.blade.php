                    ...
                    <div class="modal-content">
                        <form method="post" action="">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Da li želite obrisati kategoriju: </h5>
                    ...
                    <table class="overflow-hidden shadow-lg rounded-xl min-w-full border-[1px] border-[#e4dfdf]" id="myTable">
                        ...
                        <tbody id="myTableBody" class="bg-white">
                            ...
                            <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                ...
                                <td class="px-4 py-4 text-sm leading-5 whitespace-no-wrap">{{ html_entity_decode(Str::limit($category->description, 200)) }}</td>
                                <td class="px-4 py-4 text-sm leading-5 text-right whitespace-no-wrap">
                                    ...
                                    <div
                                        ...
                                        <div class="absolute right-[25px] w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                            ...
                                            <div class="py-1">
                                                <a href="{{ route('category.edit', $category) }}" tabindex="0"
                            ...
                            <tr class="border-b-[1px] border-[#e4dfdf]">
                                ...
                                <th class="px-4 py-4 leading-4 tracking-wider text-left">Naziv<a href="#"></a>
                                </th>
                                <th class="px-4 py-4 text-sm leading-4 tracking-wider text-left">Opis</th>
                                <th class="px-4 py-4"> </th>
                            </tr>
