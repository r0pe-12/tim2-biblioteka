            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="{{route('language.bulkDelete')}}">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Da li želite obrisati sledeće jezike: </h5>
        ...
        <section class="w-screen h-screen pl-[80px] py-4 text-gray-700">
            ...
            <div class="height-kategorije pb-[30px] scroll">
                ...
                <div class="flex items-center px-[50px] py-8 space-x-3 rounded-lg">
                    ...
                    <a href="#" class="text-red-800 multiple" id="deleteMany" hidden data-toggle="modal" data-target="#deleteManyModal"><i class="fa fa-trash ml-4"></i> Izbriši jezike</a>


                    <a class="text-blue-800 one" hidden id="edit" href="#"><i class="far fa-edit"></i> Izmjeni jezik</a>
                    <a href="#" class="text-red-800 one deleteOne" id="deleteOne" hidden data-toggle="modal" data-target="#deleteOneModal"><i class="fa fa-trash ml-4"></i> Izbriši jezik</a>
                </div>
                    <div
                        ...
                        <tbody id="myTableBody" class="bg-white">
                            @foreach($languages as $language)
                                ...
                                <td class="px-4 py-4 whitespace-no-wrap">
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" class="form-checkbox checkOthers" data-name="{{ $language->name }}" data-id="{{ $language->id }}">
                                    </label>
                                </td>
                                        ...
                                        <div class="absolute right-[25px] w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                            ...
                                            <div class="py-1">
                                                ...
                                                <a href="#" tabindex="0" data-toggle="modal" data-target="#deleteOneModal"
                                                   data-name="{{ $language->name }}" data-id="{{ $language->id }}"
