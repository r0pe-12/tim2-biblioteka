    ...
    @endsection
                ...
                <div class="modal-content">
                    <form method="post" action="{{ route('author.delete-profile-photo', $author) }}">
                        ...
                        <div class="modal-header">
                            <h2 class="modal-title" id="exampleModalLabel"><b>Da li želite obrisati sliku autora: {{ $author->name }} {{ $author->surname }}</b></h2>
        ...
        <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <div class="scroll height-content section-content">
                <form id="form" method="POST" class="text-gray-700 forma" action="{{ route('authors.update', $author) }}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
