                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="center" style="font-size:18px;color:#0e0e0f;font-weight:700;font-family:Verdana;line-height:28px;vertical-align:top;text-align:center;padding:35px 40px 0px 40px">
                                                        <strong>{{ ucfirst(strtolower($reservation->closingReason->name)) }}</strong>
                                                ...
                                                <tr>
                                                    <td class="m_2113659865872709336content" style="font:16px/22px 'Helvetica Neue',Arial,'sans-serif';text-align:left;color:#555555;padding:40px 40px 0 40px">
                                                        ...
                                                        <p> Rezervacija knjige <b>"{{ $reservation->book->title }}"</b> je istekla dana {{ \App\Models\Carbon::parse($reservation->status()->datum)->format('d.m.Y.') }} </p>
                                                        @if($reservation->book->ableToBorrow())
                                                            <p>Jos uvijek mozete preuzeti knjigu: <b>{{ ($reservation->book->samples)-($reservation->book->borrowedSamples)-($reservation->book->reservedSamples) }}</b> na stanju</p>
                                                        @endif
