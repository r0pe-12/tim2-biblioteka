        ...
        <section class="w-screen h-screen py-4 pl-[80px] text-[#333333]">
            ...
            <div class="scroll height-dashboard">
                ...
                <div class="flex items-center justify-between px-[30px] py-4 space-x-3 rounded-lg">
                    ...
                    <a href="#" class="text-red-800 multiple" id="deleteMany" hidden data-toggle="modal" data-target="#deleteManyModal"><i class="fa fa-trash ml-4"></i> Izbriši bibliotekare</a>
                    ...
                    <a href="#" class="text-red-800 one deleteOne" id="deleteOne" hidden data-toggle="modal" data-target="#deleteOneModal"><i class="fa fa-trash ml-4"></i> Izbriši bibliotekara</a>
                    <div></div>
                </div>
