                            ...
                            <label class="mt-6 cursor-pointer">
                                <div id="empty-cover-art" class="relative w-48 h-48 py-[48px] text-center border-2 border-gray-300 border-solid">
                                    <div class="py-4">
                                        ...
                                        <input type='file' name="photoPath" class="hidden" :accept="accept" onchange="loadFileLibrarian(event)" />
                                    </div>
                                    <img src="{{ $librarian->photoPath }}" id="image-output-librarian" class="absolute w-48 h-[188px] bottom-0" />
                                </div>
                            </label>
