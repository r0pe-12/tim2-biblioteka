                    ...
                    <div class="flex flex-row items-center justify-end my-2">
                        ...
                        <div>
                            <nav class="relative z-0 inline-flex">
                                ...
                                <div>
                                    <a href="#" class="relative inline-flex items-center px-2 py-2 font-medium leading-5 text-gray-500 transition duration-150 ease-in-out bg-white text-md rounded-l-md hover:text-gray-400 focus:z-10 focus:outline-none"
                                       aria-label="Previous"
