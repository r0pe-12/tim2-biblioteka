    ...
    @endsection
        ...
        <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <div class="scroll height-content section-content">
                <form id="form" method="POST" class="text-gray-700 text-[14px] forma" action="{{ route('students.update', $student) }}" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-row ml-[30px]">
                        <div class="w-[50%] mb-[100px]">
                            ...
                            <div class="mt-[20px]">
                                ...
                                <input autocomplete="off" maxlength="13" type="text" name="jmbgUcenikEdit" id="jmbgUcenikEdit" value="{{ $student->jmbg }}" class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" onkeydown="clearErrorsJmbgUcenikEdit()"/>
